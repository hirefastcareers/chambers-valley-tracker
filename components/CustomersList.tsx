                    ...
                    <div className="shrink-0 flex flex-col items-end gap-2">
                      {c.phone && whatsapp ? (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-[#25D366] text-white text-sm font-semibold btn-primary-interactive w-full sm:w-auto"
                      ...
                      {editHrefId ? (
                        <Link
                          ...
                          className="px-3 py-2 rounded-xl border border-[var(--color-border)] text-sm font-semibold text-[var(--color-primary)] bg-[var(--color-white)] btn-primary-interactive w-full sm:w-auto text-center"
                          onClick={(e) => e.stopPropagation()}
                        >
                          Edit
                        </Link>
                      ) : (
                        <div className="px-3 py-2 rounded-xl border border-[var(--color-border)] text-sm font-semibold text-[var(--color-text-muted)] bg-[var(--color-white)] w-full sm:w-auto text-center">
                          Edit
                        </div>
                      )}
                      ...
                      {editHrefId && Number(editHrefId) > 0 ? (
                        <button
                          ...
                          className="px-3 py-2 rounded-xl border border-[var(--color-border)] text-sm font-semibold text-[var(--color-red)] bg-[var(--color-red-bg)] btn-destructive-press disabled:opacity-60 w-full sm:w-auto"
