      ...
      <PageHeader className="!mb-0">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h1 className="text-[22px] font-semibold text-[var(--c-text)] leading-tight">Jobs</h1>
          ...
          <button
            ...
            className="shrink-0 btn-header-outline btn-outline-interactive"
          >
        ...
        <div className="flex flex-col gap-2">
          ...
          {hasMore ? (
            <button
              type="button"
              onClick={loadMore}
              className="rounded-[10px] border border-[var(--c-border-strong)] bg-[var(--c-surface)] px-5 py-3 text-[14px] font-semibold text-[var(--c-text)] btn-outline-interactive"
            >
              Load more
            </button>
          ) : null}
